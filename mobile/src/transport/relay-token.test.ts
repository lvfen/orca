...
import { decodeRelayCertificateToken } from './relay-token'

describe('decodeRelayCertificateToken', () => {
  ...
  it('rejects malformed certificate tokens', () => {
    ...
    expect(decodeRelayCertificateToken('not-a-certificate-token')).toBeNull()
  })
})
